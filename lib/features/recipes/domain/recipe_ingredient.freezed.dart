...
/// and is never overwritten by a later machine pass.
 MatchMethod? get matchMethod; double? get matchConfidence; DateTime? get matchedAt;
...
int get hashCode {
  final _this = this as RecipeIngredient;
  return Object.hash(runtimeType,_this.position,_this.rawText,_this.id,_this.section,_this.ingredientId,_this.displayName,_this.quantity,_this.unitCode,_this.note,_this.isOptional,_this.matchMethod,_this.matchConfidence,_this.matchedAt);
}
...
@useResult
$Res call({
 int position, String rawText, String? id, String? section, String? ingredientId, String? displayName, Quantity? quantity, String? unitCode, String? note, bool isOptional, MatchMethod? matchMethod, double? matchConfidence, DateTime? matchedAt
});
...
/// Create a copy of RecipeIngredient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? position = null,Object? rawText = null,Object? id = freezed,Object? section = freezed,Object? ingredientId = freezed,Object? displayName = freezed,Object? quantity = freezed,Object? unitCode = freezed,Object? note = freezed,Object? isOptional = null,Object? matchMethod = freezed,Object? matchConfidence = freezed,Object? matchedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int position,  String rawText,  String? id,  String? section,  String? ingredientId,  String? displayName,  Quantity? quantity,  String? unitCode,  String? note,  bool isOptional,  MatchMethod? matchMethod,  double? matchConfidence,  DateTime? matchedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeIngredient() when $default != null:
return $default(_that.position,_that.rawText,_that.id,_that.section,_that.ingredientId,_that.displayName,_that.quantity,_that.unitCode,_that.note,_that.isOptional,_that.matchMethod,_that.matchConfidence,_that.matchedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int position,  String rawText,  String? id,  String? section,  String? ingredientId,  String? displayName,  Quantity? quantity,  String? unitCode,  String? note,  bool isOptional,  MatchMethod? matchMethod,  double? matchConfidence,  DateTime? matchedAt)  $default,) {final _that = this;
switch (_that) {
case _RecipeIngredient():
return $default(_that.position,_that.rawText,_that.id,_that.section,_that.ingredientId,_that.displayName,_that.quantity,_that.unitCode,_that.note,_that.isOptional,_that.matchMethod,_that.matchConfidence,_that.matchedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int position,  String rawText,  String? id,  String? section,  String? ingredientId,  String? displayName,  Quantity? quantity,  String? unitCode,  String? note,  bool isOptional,  MatchMethod? matchMethod,  double? matchConfidence,  DateTime? matchedAt)?  $default,) {final _that = this;
switch (_that) {
case _RecipeIngredient() when $default != null:
return $default(_that.position,_that.rawText,_that.id,_that.section,_that.ingredientId,_that.displayName,_that.quantity,_that.unitCode,_that.note,_that.isOptional,_that.matchMethod,_that.matchConfidence,_that.matchedAt);case _:
  return null;
...
class _RecipeIngredient extends RecipeIngredient {
  const _RecipeIngredient({required this.position, required this.rawText, this.id, this.section, this.ingredientId, this.displayName, this.quantity, this.unitCode, this.note, this.isOptional = false, this.matchMethod, this.matchConfidence, this.matchedAt}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,position,rawText,id,section,ingredientId,displayName,quantity,unitCode,note,isOptional,matchMethod,matchConfidence,matchedAt);
}

@override
String toString() {
    return 'RecipeIngredient(position: $position, rawText: $rawText, id: $id, section: $section, ingredientId: $ingredientId, displayName: $displayName, quantity: $quantity, unitCode: $unitCode, note: $note, isOptional: $isOptional, matchMethod: $matchMethod, matchConfidence: $matchConfidence, matchedAt: $matchedAt)';
}
...
/// Create a copy of RecipeIngredient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? position = null,Object? rawText = null,Object? id = freezed,Object? section = freezed,Object? ingredientId = freezed,Object? displayName = freezed,Object? quantity = freezed,Object? unitCode = freezed,Object? note = freezed,Object? isOptional = null,Object? matchMethod = freezed,Object? matchConfidence = freezed,Object? matchedAt = freezed,}) {
