...
/// ingredient line: a recipe still renders without its picture.
 String? get imageUrl; List<String> get tags;/// A household fact, not a personal one (D24): any member's tap changes
/// it for everyone. Written only by `setFavorite`, never by the recipe
/// editor's `update` (D100).
 bool get isFavorite;/// 1-5, or null for unrated. Same household-fact scoping as [isFavorite],
/// written only by `setRating`.
 int? get rating; DateTime? get updatedAt; DateTime? get deletedAt;
...
int get hashCode {
  final _this = this as Recipe;
  return Object.hashAll([runtimeType,_this.id,_this.householdId,_this.title,_this.originalLocale,_this.sourceType,_this.status,_this.createdBy,_this.description,_this.servings,_this.prepMinutes,_this.cookMinutes,_this.sourceUrl,_this.sourceAttribution,_this.imagePath,_this.imageUrl,const DeepCollectionEquality().hash(_this.tags),_this.isFavorite,_this.rating,_this.updatedAt,_this.deletedAt]);
}

@override
String toString() {
  final _this = this as Recipe;
  return 'Recipe(id: ${_this.id}, householdId: ${_this.householdId}, title: ${_this.title}, originalLocale: ${_this.originalLocale}, sourceType: ${_this.sourceType}, status: ${_this.status}, createdBy: ${_this.createdBy}, description: ${_this.description}, servings: ${_this.servings}, prepMinutes: ${_this.prepMinutes}, cookMinutes: ${_this.cookMinutes}, sourceUrl: ${_this.sourceUrl}, sourceAttribution: ${_this.sourceAttribution}, imagePath: ${_this.imagePath}, imageUrl: ${_this.imageUrl}, tags: ${_this.tags}, isFavorite: ${_this.isFavorite}, rating: ${_this.rating}, updatedAt: ${_this.updatedAt}, deletedAt: ${_this.deletedAt})';
}
...
@useResult
$Res call({
 String id, String householdId, String title, String originalLocale, RecipeSourceType sourceType, RecipeStatus status, String createdBy, String? description, int? servings, int? prepMinutes, int? cookMinutes, String? sourceUrl, String? sourceAttribution, String? imagePath, String? imageUrl, List<String> tags, bool isFavorite, int? rating, DateTime? updatedAt, DateTime? deletedAt
});
...
/// Create a copy of Recipe
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? householdId = null,Object? title = null,Object? originalLocale = null,Object? sourceType = null,Object? status = null,Object? createdBy = null,Object? description = freezed,Object? servings = freezed,Object? prepMinutes = freezed,Object? cookMinutes = freezed,Object? sourceUrl = freezed,Object? sourceAttribution = freezed,Object? imagePath = freezed,Object? imageUrl = freezed,Object? tags = null,Object? isFavorite = null,Object? rating = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,}) {
  return _then(Recipe(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String householdId,  String title,  String originalLocale,  RecipeSourceType sourceType,  RecipeStatus status,  String createdBy,  String? description,  int? servings,  int? prepMinutes,  int? cookMinutes,  String? sourceUrl,  String? sourceAttribution,  String? imagePath,  String? imageUrl,  List<String> tags,  bool isFavorite,  int? rating,  DateTime? updatedAt,  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Recipe() when $default != null:
return $default(_that.id,_that.householdId,_that.title,_that.originalLocale,_that.sourceType,_that.status,_that.createdBy,_that.description,_that.servings,_that.prepMinutes,_that.cookMinutes,_that.sourceUrl,_that.sourceAttribution,_that.imagePath,_that.imageUrl,_that.tags,_that.isFavorite,_that.rating,_that.updatedAt,_that.deletedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String householdId,  String title,  String originalLocale,  RecipeSourceType sourceType,  RecipeStatus status,  String createdBy,  String? description,  int? servings,  int? prepMinutes,  int? cookMinutes,  String? sourceUrl,  String? sourceAttribution,  String? imagePath,  String? imageUrl,  List<String> tags,  bool isFavorite,  int? rating,  DateTime? updatedAt,  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _Recipe():
return $default(_that.id,_that.householdId,_that.title,_that.originalLocale,_that.sourceType,_that.status,_that.createdBy,_that.description,_that.servings,_that.prepMinutes,_that.cookMinutes,_that.sourceUrl,_that.sourceAttribution,_that.imagePath,_that.imageUrl,_that.tags,_that.isFavorite,_that.rating,_that.updatedAt,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String householdId,  String title,  String originalLocale,  RecipeSourceType sourceType,  RecipeStatus status,  String createdBy,  String? description,  int? servings,  int? prepMinutes,  int? cookMinutes,  String? sourceUrl,  String? sourceAttribution,  String? imagePath,  String? imageUrl,  List<String> tags,  bool isFavorite,  int? rating,  DateTime? updatedAt,  DateTime? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _Recipe() when $default != null:
return $default(_that.id,_that.householdId,_that.title,_that.originalLocale,_that.sourceType,_that.status,_that.createdBy,_that.description,_that.servings,_that.prepMinutes,_that.cookMinutes,_that.sourceUrl,_that.sourceAttribution,_that.imagePath,_that.imageUrl,_that.tags,_that.isFavorite,_that.rating,_that.updatedAt,_that.deletedAt);case _:
  return null;
...
class _Recipe implements Recipe {
  const _Recipe({required this.id, required this.householdId, required this.title, required this.originalLocale, required this.sourceType, required this.status, required this.createdBy, this.description, this.servings, this.prepMinutes, this.cookMinutes, this.sourceUrl, this.sourceAttribution, this.imagePath, this.imageUrl,  List<String> tags = const <String>[], this.isFavorite = false, this.rating, this.updatedAt, this.deletedAt}): _tags = tags;
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,householdId,title,originalLocale,sourceType,status,createdBy,description,servings,prepMinutes,cookMinutes,sourceUrl,sourceAttribution,imagePath,imageUrl,const DeepCollectionEquality().hash(_tags),isFavorite,rating,updatedAt,deletedAt]);
}

@override
String toString() {
    return 'Recipe(id: $id, householdId: $householdId, title: $title, originalLocale: $originalLocale, sourceType: $sourceType, status: $status, createdBy: $createdBy, description: $description, servings: $servings, prepMinutes: $prepMinutes, cookMinutes: $cookMinutes, sourceUrl: $sourceUrl, sourceAttribution: $sourceAttribution, imagePath: $imagePath, imageUrl: $imageUrl, tags: $tags, isFavorite: $isFavorite, rating: $rating, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
